        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6">
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">Participants</h1>
                        <p className="text-sm text-slate-600 dark:text-slate-300">
                            {programme.title} · {participantsList.length.toLocaleString()} joined ·{' '}
                ...
                <div className="grid gap-4 lg:grid-cols-[1fr_340px]">
                    <div className="space-y-4">
                        <div className="rounded-lg border border-slate-200 bg-white p-4 text-xs dark:border-slate-800 dark:bg-slate-950">
                        ...
                        <div className="flex items-center justify-between gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs dark:border-slate-800 dark:bg-slate-900/40">
                    ...
                    <div className="rounded-lg border border-slate-200 bg-white p-4 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300">
                        ...
                        <div className="mt-2 space-y-2">
                            <div>
                                ...
                                <div className="text-sm font-medium text-slate-800 dark:text-slate-200">{programme.title}</div>
                            </div>
                            <div>
