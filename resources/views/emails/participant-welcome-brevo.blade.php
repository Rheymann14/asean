                            ...
                            <td style="padding: 20px 28px 8px;">
                                @php
                                    $bannerSrc = $bannerPath
                                        ? 'data:image/png;base64,' . base64_encode(file_get_contents($bannerPath))
                                        : $bannerUrl;
                                @endphp
                                        ...
                                        <td style="padding-bottom: 10px;">
                                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 40px; vertical-align: middle;">
                                                        @php
                                                            $bagongPilipinasSrc = $bagongPilipinasPath
                                                                ? 'data:image/png;base64,' . base64_encode(file_get_contents($bagongPilipinasPath))
                                                                : $bagongPilipinasUrl;
                                                        @endphp
