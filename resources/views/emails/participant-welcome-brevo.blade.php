                    ...
                    <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden;">
                        <tr>
                            <td style="padding: 20px 28px 8px;">
                                <img src="{{ $bannerDataUrl ?? $bannerUrl }}" alt="ASEAN Philippines 2026 banner" style="display: block; width: 100%; max-width: 260px; height: auto;" />
                            </td>
                        </tr>
                        <tr>
                                            ...
                                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="width: 40px; vertical-align: middle;">
                                                        <img src="{{ $logoDataUrl ?? $logoUrl }}" alt="ASEAN logo" style="width: 36px; height: 36px; display: block;" />
                                                    </td>
                                                    <td style="width: 40px; vertical-align: middle;">
                                                        <img src="{{ $bagongPilipinasDataUrl ?? $bagongPilipinasUrl }}" alt="Bagong Pilipinas logo" style="width: 36px; height: 36px; display: block;" />
                                                    </td>
