...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::kyY0Mkav01VkAOMA',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::WU84pimfpWcai69i',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/reset\\-password/([^/]++)(*:32)|/email/verify/([^/]++)/([^/]++)(*:70)|/p(?|articipants/(?|([^/]++)(?|(*:108))|countries(?|(*:129)|/([^/]++)(?|(*:149)))|user\\-types(?|(*:173)|/([^/]++)(?|(*:193))))|rogrammes/([^/]++)(?|(*:225)))|/venues/([^/]++)(?|(*:254))|/issuances/([^/]++)(?|(*:285))|/contact\\-details/([^/]++)(*:320)|/storage/(.*)(*:341))/?$}sDu',
    ),
    3 => 
    array (
      32 => 
  ...
  array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:843:"function () {
                ...
                }";s:5:"scope";s:54:"Illuminate\\Foundation\\Configuration\\ApplicationBuilder";s:4:"this";N;s:4:"self";s:32:"00000000000009190000000000000000";}}',
        'as' => 'generated::kyY0Mkav01VkAOMA',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ContactDetailController@publicIndex',
        'controller' => 'App\\Http\\Controllers\\ContactDetailController@publicIndex',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\VenueController@publicIndex',
        'controller' => 'App\\Http\\Controllers\\VenueController@publicIndex',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ProgrammeController@publicIndex',
        'controller' => 'App\\Http\\Controllers\\ProgrammeController@publicIndex',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\IssuanceController@publicIndex',
        'controller' => 'App\\Http\\Controllers\\IssuanceController@publicIndex',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\IssuanceController@index',
        'controller' => 'App\\Http\\Controllers\\IssuanceController@index',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'issuances.store',
        'uses' => 'App\\Http\\Controllers\\IssuanceController@store',
        'controller' => 'App\\Http\\Controllers\\IssuanceController@store',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'issuances.update',
        'uses' => 'App\\Http\\Controllers\\IssuanceController@update',
        'controller' => 'App\\Http\\Controllers\\IssuanceController@update',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'issuances.destroy',
        'uses' => 'App\\Http\\Controllers\\IssuanceController@destroy',
        'controller' => 'App\\Http\\Controllers\\IssuanceController@destroy',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ContactDetailController@index',
        'controller' => 'App\\Http\\Controllers\\ContactDetailController@index',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'contact-details/{contactDetail}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\ContactDetailController@update',
        'controller' => 'App\\Http\\Controllers\\ContactDetailController@update',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'contact-details.update',
      ),
      'fallback' => false,
      'defaults' => 
      array (
